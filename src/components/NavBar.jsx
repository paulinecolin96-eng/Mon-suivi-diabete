  ...
  return (
    <header style={{ background: bgColor, position: 'sticky', top: 0, zIndex: 100, boxShadow: '0 3px 18px rgba(0,30,90,0.4)' }}>
      <div style={{ maxWidth: 920, margin: '0 auto', padding: '13px 24px', display: 'flex', alignItems: 'center', gap: 14 }}>
        ...
        <button onClick={() => goTo('home')} style={{ background: mode === 'dashboard' ? '#7c3aed' : C.orange, borderRadius: 8, width: 40, height: 40, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, border: 'none', cursor: 'pointer' }}>
